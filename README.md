...
Без ввода пароля невозможна работа с API Школы. Логин и пароль от Платформы вводятся на главной странице http://localhost:8000/

**Хранить пароль в браузере:** 
можно ввести логины и пароли в форму и выбрать "Запомнить данные в браузере". Данные будут храниться в локальном хранилище браузера

**Не хранить пароль в браузере:** 
можно ввести логины и пароли в форму и не сохранять данные в браузере. Будет создан куки с логином и паролем, который удаляется при завершении сессии.
